import { getAcademicService, type AvailableServicesResponse } from "@/services/academicService/academic-service.service";
...
export function useQueryAvailableServices({
    ...
    const { data, isLoading, error, isError } = useQuery<AvailableServicesResponse>({
