...
import { ReferenciasDialog } from '@/pages/finance/componets/referencie-dialog'
import { InvoicesTableSkeleton } from '@/pages/finance/componets/invoices-table-skeleton'
...
type InvoicesTableProps = { enrollmentCode: string; selectedYear: string }
...
export function PreInvoice({
  ...
  const [isOpenPaymentDialog, setIsOpenPaymentDialog] = useState<boolean>(false)
    ...
    <Card className="overflow-hidden shadow-sm">
      <CardHeader className="border-b bg-muted/30">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <CardTitle className="text-2xl font-bold">Pagamentos</CardTitle>
        </div>
      </CardHeader>
      ...
      <PaymentDialog
        ...
        onOpenChange={() => onClosePaymentModal()}
      />
    </Card>
  )
}
